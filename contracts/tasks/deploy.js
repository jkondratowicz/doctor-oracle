...
task('deploy', 'Deploys the DoctorOracle contract')
  .addOptionalParam('verify', 'Set to true to verify contract', false, types.boolean)
  .setAction(async (taskArgs) => {
    console.log(`Deploying DoctorOracle contract to ${network.name}`);
    ...
    const consumerContractFactory = await ethers.getContractFactory('DoctorOracle');
    ...
    console.log('\nDeployed DoctorOracle contract to:', consumerContract.address);
    ...
    console.log(`\nDoctorOracle contract deployed to ${consumerContract.address} on ${network.name}`);
  });
